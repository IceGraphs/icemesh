...
from icemesh import preprocessing as prep
...
class MeshGraphNet(torch.nn.Module):
    ...
    def forward(self,data,mean_vec_x,std_vec_x,mean_vec_edge,std_vec_edge):
        ...
        x = prep.normalize(x,mean_vec_x,std_vec_x)
        edge_attr=prep.normalize(edge_attr,mean_vec_edge,std_vec_edge)
    ...
    def loss(self, pred, inputs,mean_vec_y,std_vec_y):
        ...
        labels = prep.normalize(inputs.y,mean_vec_y,std_vec_y)
